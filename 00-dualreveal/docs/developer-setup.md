...
Run all commands from the `00-dualreveal` directory.
...
- Open the SQL editor and run the migration in `supabase/migrations/0001_dualreveal_schema.sql` (path relative to `00-dualreveal`).
